function solvemod_distance(name,varargin)
...
while or(iterT<par.minT,and(testT>=par.tolT,iterT<par.maxT))
    ...
    vvi = HJBmap2D_distance4(DD,VV(par.V.ivi,:),XX_(par.X_.irVi,:),XX_(par.X_.iuVi,:),...
        [XX_(par.X_.imuV1,:);XX_(par.X_.imuV2,:)],...
        [XX_(par.X_.isigV11,:);XX_(par.X_.isigV22,:);XX_(par.X_.isigV12,:)],par);
    vvh = HJBmap2D_distance4(DD,VV(par.V.ivh,:),XX_(par.X_.irVh,:),XX_(par.X_.iuVh,:),...
        [XX_(par.X_.imuV1,:);XX_(par.X_.imuV2,:)],...
        [XX_(par.X_.isigV11,:);XX_(par.X_.isigV22,:);XX_(par.X_.isigV12,:)],par);
